...
from frappe.query_builder.functions import Avg, Concat, Count, IfNull, LiteralValue, Max, Min, Sum
...
def get_columns(filters):
	return [
		...
		{
			"label": _("Total Colour Stone Pcs"),
			"fieldname": "total_gemstone_pcs",
			"fieldtype": "data",
			"width": 100,
		},
		...
		{
			"label": _("Metal Code"),
			"fieldname": "metal_code",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Metal purity"),
			"fieldname": "metal_purity_",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Product Dimension Metal Configuration"),
			"fieldname": "metal_purity",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Metal Colour(WatchDialMetal)"),
			"fieldname": "metal_colour",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Metal Line Number"),
			"fieldname": "metal_line_no",
			"fieldtype": "data",
			"width": 150,
		},
		{"label": _("Gross Wt"), "fieldname": "gross_weight", "fieldtype": "data", "width": 100},
		{
			"label": _("Total Gold wt.(Net Wt for SKU)"),
			"fieldname": "total_metal_weight",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("BOM Metal Item"),
			"options": "Item",
			"fieldname": "bom_metal_item",
			"fieldtype": "Link",
			"width": 150,
		},
		{
			"label": _("Net Gold Weight"),
			"fieldname": "total_metal_weight",
			"fieldtype": "data",
			"width": 100,
		},
		...
		{
			"label": _("Diamond Total Qty"),
			"fieldname": "total_diamond_weight",
			"fieldtype": "data",
			"width": 150,
		},
		...
		{
			"label": _("Diamond Size Name"),
			"fieldname": "diamond_size_name",
			"fieldtype": "data",
			"width": 180,
		},
		{
			"label": _("Diamond Stone Item"),
			"options": "Item",
			"fieldname": "diamond_stone_item",
			"fieldtype": "Link",
			"width": 150,
		},
		{
			"label": _("Diamond Sieve size"),
		...
		{"label": _("Diamond Rate"), "fieldname": "", "fieldtype": "data", "width": 150},
		{"label": _("Diamond Amount"), "fieldname": "", "fieldtype": "data", "width": 150},
		{"label": _("Total Diamond Amount"), "fieldname": "", "fieldtype": "data", "width": 150},
		{"label": _("Diamond Stone Ct Unit"), "fieldname": "CT", "fieldtype": "data", "width": 150},
		# BOM Gemstone Detail Column
		# {"label": _("GEM Name"),"fieldname": "gname","fieldtype": "data","width": 150,},
		{
			"label": _("Colour Stone Item"),
			"fieldname": "gemstone_type",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Colour Stone Shape"),
			"fieldname": "color_stone_shape",
			"fieldtype": "data",
			"width": 180,
		},
		{
			"label": _("Colored Stone Cut/Vendor"),
			"fieldname": "cut_or_cab",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Colour Stone Size"),
			"fieldname": "gemstone_size",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Colour Stone Code"),
			"fieldname": "gemstone_code",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Colour Stone Pcs"),
			"fieldname": "colour_stone_pcs",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Colour Stone Ct"),
			"fieldname": "colour_stone_qty",
			"fieldtype": "data",
			"width": 150,
		},
		...
		{
			"label": _("Product Dimension Group"),
			"fieldname": "prod_dimension_gp",
			"fieldtype": "data",
			"width": 150,
		},
		{"label": _("Revision Collection"), "fieldname": "", "fieldtype": "data", "width": 150},
		{
			"label": _("Revision Collection Code"),
			"fieldname": "revision_collection_code",
			"fieldtype": "data",
			"width": 180,
		},
		...
		{
			"label": _("Manufacturing Type(MFG-Code)"),
			"fieldname": "CA",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Style-(Pearl Type Code(WatchDialIndex)"),
			"fieldname": "SR",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Set Ref-Pearl Colour(WatchDialColor)"),
			"fieldname": "",
			"fieldtype": "data",
			"width": 150,
		},
		{
			"label": _("Set Ref-Pearl Colour Code(WatchDialColor)"),
			"fieldname": "",
			"fieldtype": "data",
			"width": 150,
		},
		...
		{
			"label": _("Manufacturing type(Mfg_description)"),
			"fieldname": "",
			"fieldtype": "data",
			"width": 150,
		},
...
def get_diamond(filters):
	...
	diamond_data = (
		qb.from_(Quotation)
		.left_join(QI)
		.on(QI.parent == Quotation.name)
		.left_join(C)
		.on(C.name == Quotation.party_name)
		.left_join(CMN)
		.on(CMN.parent == C.name)
		.left_join(CPD)
		.on(CPD.parent == C.name)
		.left_join(CCC)
		.on(CCC.parent == C.name)
		.left_join(B)
		.on(B.name == QI.quotation_bom)
		.left_join(BDM)
		.on(BDM.parent == B.name)
		.select(
...
def max_length(filters):
	...
	length = (
		...
		.where(conditions)
		.run(as_dict=True)  # Replace with your conditions
	)
	return length
