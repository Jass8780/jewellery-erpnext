...
frappe.ui.form.on("Making Charge Price", {
	setup: function (frm) {
		...
		var child_fields = [["subcategory", "Item Sub-Category"]];
		set_filters_on_child_table_fields(frm, child_fields, "subcategory");

		var finding_child_fields = [["subcategory", "Finding Sub-Category"]];
		set_filters_on_child_table_fields(frm, finding_child_fields, "finding_subcategory");
